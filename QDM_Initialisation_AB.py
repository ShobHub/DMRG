...
ws = np.zeros((7, 7, 2, 2))
		...
		w[3,0] = Nr[3]
		w[4,0] = Nr[2]
		w[5,0] = -self.J*(Sr_31+Sr_13) + self.Vl*(Nr[1]+Nr[3]) + self.Vlr*(Nr[0]+Nr[2])
		w[5,1] = -self.J*Sr_12
		w[5,2] = -self.J*Sr_21
		w[5,3] = self.Vl*Nr[1]
		w[5,4] = self.Vl*(Nr[0]+Nr[2]+Nr[3])
		w[5,5] = self.Vr*Nr[0]
		w[5,6] = I4
		W[1] = w
		...
		w[2, 0] = Srr_13
		w[3, 0] = Nrr[0]
		w[4, 0] = Nrr[1] + Nrr[2] + Nrr[3] + Nrr[4]
		w[5, 0] = Nrr[2]
		w[6, 0] = -self.J * (Srr_32 + Srr_23 + Srr_42 + Srr_24) + self.Vl * (Nrr[0] + Nrr[4]) + self.Vlr * (Nrr[1] + Nrr[2] + Nrr[3])
		w[6, 1] = -self.J * Srr_45
		w[6, 2] = -self.J * Srr_54
		w[6, 3] = self.Vl * Nrr[4]
		w[6, 4] = self.Vr * Nrr[3]
		...
		wA[1,0] = Sr_34
		wA[2,0] = Sr_43
		wA[3,0] = Nr[0]+Nr[1]+Nr[2]
		wA[4,0] = Nr[3]
		wA[5,0] = Nr[2]
		wA[6,0] = -self.J*(Sr_31+Sr_13) + self.Vl*(Nr[1]+Nr[3]) + self.Vlr*(Nr[0]+Nr[2])
		wA[6,1] = -self.J*Sr_12
		wA[6,2] = -self.J*Sr_21
		wA[6,3] = self.Vl*Nr[1]
		wA[6,4] = self.Vl*(Nr[0]+Nr[2]+Nr[3])
		wA[6,5] = self.Vr*Nr[0]
		wA[6,6] = I4

		wA1 = np.zeros((7, 7, 4, 4))
		wA1[0, 0] = I4
		wA1[1, 0] = Sr_34
		wA1[2, 0] = Sr_43
		wA1[3, 0] = Nr[3]
		wA1[4, 0] = Nr[0] + Nr[1] + Nr[2]
		wA1[5, 0] = Nr[2]
		wA1[6, 0] = -self.J * (Sr_31 + Sr_13) + self.Vl * (Nr[1] + Nr[3]) + self.Vlr * (Nr[0] + Nr[2])
		wA1[6, 1] = -self.J * Sr_12
		wA1[6, 2] = -self.J * Sr_21
		wA1[6, 3] = self.Vl * Nr[1]
		wA1[6, 4] = self.Vl * (Nr[0] + Nr[2] + Nr[3])
		wA1[6, 5] = self.Vr * Nr[0]
		wA1[6, 6] = I4
		...
		wB[2,0] = Srr_13
		wB[3,0] = Nrr[0]
		wB[4,0] = Nrr[1]+Nrr[2]+Nrr[3]+Nrr[4]
		wB[5,0] = Nrr[2]
		wB[6,0] = -self.J*(Srr_32+Srr_23+Srr_42+Srr_24) + self.Vl*(Nrr[0]+Nrr[4]) + self.Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		wB[6,1] = -self.J*Srr_45
		wB[6,2] = -self.J*Srr_54
		wB[6,3] = self.Vl*Nrr[4]
		wB[6,4] = self.Vl*(Nrr[0]+Nrr[1]+Nrr[2]+Nrr[3])
		wB[6,5] = self.Vr*Nrr[3]
		wB[6,6] = I5
		...
		for i in range(2,N-2):
			if(lad[i] == 'A'):
				...
				W[i] = wB
			elif(lad[i-1:i+2] == 'AsA'):
				W[i] = ws
			elif(lad[i-1:i+2] == 'Ass' or lad[i-1:i+2] == 'Bss'):
				W[i] = ws1
			elif(lad[i-1:i+2] == 'ssA' or lad[i-1:i+2] == 'ssB'):
				W[i] = ws2
			else:
				print(i,lad[i-1:i+2])
...
Old
		...
		w[3,3] = Vl*Nr[3]   
		w[3,4] = Vl*Nr[3]   
		w[4,3] = Vl*Nr[1] + Vlr*(Nr[0]+Nr[2])   
		w[4,4] = Vlr*(Nr[0]+Nr[2])    
		w[5,0] = -J*(Sr_31+Sr_13) + Vl*(Nr[1]+Nr[3]) + Vlr*(Nr[0]+Nr[2])
		w[5,5] = I4
		W[1] = w
		...
		w2 = np.zeros((6, 6, 4, 4))
		w2[0,0] = I4 
		w2[3,3] = Vl*(Nr[1] + Nr[3]) + Vlr*(Nr[0]+Nr[2])  
		w2[3,4] = Vl*Nr[3] + Vlr*(Nr[0]+Nr[2])  
		w2[4,3] = Vl*Nr[1] + Vlr*(Nr[0]+Nr[2])   
		w2[4,4] = Vlr*(Nr[0]+Nr[2])    
		w2[5,0] = -J*(Sr_31+Sr_13) + Vl*(Nr[1]+Nr[3]) + Vlr*(Nr[0]+Nr[2])
		w2[5,5] = I4
		...
		w4 = np.zeros((6, 6, 5, 5))
		w4[0,0] = I5 
		w4[3,3] = Vl*(Nrr[0] + Nrr[4]) + Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		w4[3,4] = Vl*Nrr[0] + Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		w4[4,3] = Vl*Nrr[4] + Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		w4[4,4] = Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		w4[5,0] = -J*(Srr_32+Srr_23+Srr_42+Srr_24) + Vl*(Nrr[0]+Nrr[4]) + Vlr*(Nrr[1]+Nrr[2]+Nrr[3])
		w4[5,5] = I5
		...
		for i in range(2,N-2):
			if(lad[i] == 'A'):
				...
				W[i] = w4
			elif(lad[i-1:i+2] == 'AsA' or lad[i-1:i+2] == 'Ass' or lad[i-1:i+2] == 'Bss'):
				W[i] = w1
			elif(lad[i-1:i+2] == 'ssB' or lad[i-1:i+2] == 'ssA'):
				W[i] = w3
			else:
				print(i,lad[i-1:i+2])
		if(lad[N-2] == 'A'):
